...
<section class="Centro CentroConteudo">
		<h2 class="TituloPagina">Cadastrar Serviço</h2>
		<form name="cadserv" method="post" onsubmit="return CadastrarServico(this);" enctype="multipart/form-data">
			<input type="hidden" name="cadastrarservico" value=""/>
			<div class="Linha">
				<input type="text" name="titulo" placeholder="Titulo:" class="Campo inputemp"/>
			</div>
			<div class="Linha">
				<input type="text" name="subtitulo" placeholder="Subtitulo:" class="Campo inputemp"/>
			</div>
			<div class="Linha">
