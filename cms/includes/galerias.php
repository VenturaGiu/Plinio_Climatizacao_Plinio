...
<section class="Centro CentroConteudo">
		<h2 class="TituloPagina">Cadastrar Galeria</h2>
		<form name="cadgal" method="post" onsubmit="return CadastrarGaleria(this);" enctype="multipart/form-data">
			<input type="hidden" name="cadastrargaleria" value=""/>
			<div class="Linha">
